            ...
            <div className="flex h-screen w-full bg-slate-100 dark:bg-slate-950 text-slate-900 dark:text-slate-200 overflow-hidden font-sans selection:bg-purple-500/30 transition-colors duration-300">
                ...
                <div className="flex-1 flex flex-col min-w-0">
                        ...
                        <div className="flex gap-4 items-center">
                            ...
                            <div className="flex items-center gap-1">
                                <span className="text-sm text-slate-500 hidden md:block">
                                    <span className={isSyncing ? "animate-spin inline-block mr-1" : ""}>
                                        {isSyncing ? <RefreshCw size={14} /> : (pendingChanges.length > 0 ? "Changes Pending" : "Up to date")}
                                    </span>
                                </span>
                    ...
                    <div className="flex-1 overflow-x-auto overflow-y-hidden px-4 pb-2">
                        <div className="flex gap-6 h-full items-start pt-8 px-4 pb-8">
                            {sprints.map(sprint => (
